      ...
      <div class="card-body text-dark">
        <center>
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink-2">
                <li><a class="expanded_link dropdown-item toggle_expanded_view" href="/pre_1992_legislation/1/{{$allPre1992Act['pre_1992_group']}}/{{$allPre1992Act['title']}}/expanded-view/{{ $allPre1992Act['id'] }}"><center>Expanded View</center></a></li>
                
                @if (Route::has('login'))
                    @auth
                        {{-- View Plain View --}}
                            <li><a class="dropdown-item" href="/pre_1992_legislation/1/{{$allPre1992Act['pre_1992_group']}}/{{$allPre1992Act['title']}}/plain_view/{{ $allPre1992Act['id'] }}" target="_blank"><center>Plain View</center></a></li>
                        @else
                        {{-- Create Account --}}
