      ...
      <div class="panel-body">
        ...
        <div class="btn-group">
              <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <small>District Court Cases</small> <span class="caret"></span>
              </button>
              <ul class="dropdown-menu scroll-view-judgement" style="width: 520px;">
                @foreach($districtCourts as $districtCourt) 
                  <!--<li><a class="view_all_section_link" href="/judgement/district-court/case/{{$districtCourt->id}}">{{$districtCourt->case_title}}</a></li>-->
                  <li>
