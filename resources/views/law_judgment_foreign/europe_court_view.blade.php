...
@section('title', $europeJudgement['case_title'])
@section('assets')
                ...
                <div class="col-md-9 judgement_display" style="height: 600px;">
                    <div id="display_content">
                        ...
                        <div class="menu_options pull-right" style="display: none;">
                                <a href="/judgement/pdf_view/foreign/{{ $europeJudgement['country_name'] }}/{{$europeJudgement['id']}}"><img alt="Brand" src="{{ asset('/logo/pdf.png') }}" style="width:1.5em;">&nbsp;PDF</a>&nbsp;&nbsp;||&nbsp;
                                <a href="/judgement/plain_view/foreign/{{$europeJudgement['id']}}" target="_blank">Plain View</a>&nbsp;&nbsp;||&nbsp;
                                <a href="/judgement/print_preview/foreign/{{$europeJudgement['id']}}" target="_blank"><span class="glyphicon glyphicon-print" aria-hidden="true"></span>&nbsp;Print Preview</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            </div>

                        <div class="content">	
                        <p>{!! $europeJudgement['content'] !!}</p>
                        </div>
                    </div> 
