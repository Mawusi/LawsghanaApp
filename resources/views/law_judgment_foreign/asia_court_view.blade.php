...
@section('title', $asiaJudgement['case_title'])
@section('assets')
                    ...
                    <div class="panel panel-default">
                        ...
                        {{-- View all sections --}}
                                ...
                                <div class="btn-group" style="margin-bottom: 10px;">
                                    ...
                                    <li><a class="alt_section_link" href="/judgement/all-countries/2/{{ $asiaJudgement->country_name }}/{{ $asiaJudgement->id}}">{{$asiaJudgement->case_title }}</a></li>
                                    @endforeach
                                    </ul>
                                </div>
                                </center>
