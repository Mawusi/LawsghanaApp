            ...
            <div class="card-body">
                <form method="post" action="{{ route('users.update', $user) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="type" class="form-control" name="name" value="{{ $user->name }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="type" class="form-control" name="lname" value="{{ $user->lname }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input type="type" class="form-control" name="phone" value="{{ $user->phone }}">
                        </div>
                    </div>
