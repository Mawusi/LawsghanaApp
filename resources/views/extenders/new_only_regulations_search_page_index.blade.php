      ...
      <div class="col-md-3 mx-auto">
        <div class="sidebar">
          <div class="search-well-filter">
            <h5 style="color:blue;">Legislative Instruments Search</h5><hr>
            <span style="color:blue;">Filter Options</span>
            <p class="small" style="color:blue;"><b><span style="color:red;">{{number_format($regulations_count)}}</span>&nbsp;Results Found&nbsp;for&nbsp;<span style="color:red;">"{{$query}}"</span></b></p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-9">
        <div><br></div>
            ...
            <div class="search-well">
                <h5 style="color:blue;"><b>{!! $regulation->regulation_title !!}</b></h4>
                <b>{!! $regulation->section !!}</b>
