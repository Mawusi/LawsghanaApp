<div class="only_africa">
    ...
    <a href="/constitution/1/{{$africa_countries_constitution->continent}}/{{$africa_countries_constitution->country}}/{{$africa_countries_constitution->id}}" target="_blank"><h5 style="color:blue;"><b>{!! $africa_countries_constitution->title !!}</b></h5></a>
