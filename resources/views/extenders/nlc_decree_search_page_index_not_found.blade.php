...
<div class="container-fluid">
  ...
  <div class="row">
      ...
      <p style="color:blue;"><b class="hidden">Found: {{$nlc_decree_laws_count}} Results</b></p>
      </div>
      ...
      <div class="col-md-3">
        <div class="sidebar">
          <div class="search-well-filter">
            <p class="small" style="color:blue;"><b><span style="color:red;">{{number_format($nlc_decree_laws_count)}}</span>&nbsp;Results Found&nbsp;for&nbsp;<span style="color:red;">"{{$query}}"</span></b></p>
          </div>
        </div>
      </div>
