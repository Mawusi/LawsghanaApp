      ...
      <div class="col-md-3 mx-auto">
        <div class="sidebar">
          <div class="search-well-filter">
            <h5 style="color:blue;">Europe Constitution Search</h5><hr>
      ...
      <div class="col-md-9">
        <div><br></div>
            ...
            <div class="search-well">
                <h4 style="color:blue;"><b>{!! $europe_countries_constitution->title !!}</b></h4>
            ...
            <br>
            {!! $europe_countries_constitution->content !!}
            </div>
            <br>
            @endforeach                                    
      </div>
