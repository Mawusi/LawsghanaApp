      ...
      <div class="col-md-3">
        <div class="sidebar">
          <div class="search-well-filter">
            <p class="small" style="color:blue;"><b><span style="color:red;">{{number_format($constitutional_count)}}</span>&nbsp;Results Found&nbsp;for&nbsp;<span style="color:red;">"{{$query}}"</span></b></p>
        ...
        <div class="">
          <div class="move_here hidden  top_here"><br></div>
            ...
            <div class="search-well">
                <h5 style="color:blue;"><b>{!! $constitutional->constitutional_act !!}</b></h4>
                <b>{!! $constitutional->section !!}</b>
