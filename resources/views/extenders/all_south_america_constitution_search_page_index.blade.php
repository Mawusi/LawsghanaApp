  ...
  <div class="row">
      <div class="col-md-3 mx-auto">
        <div class="sidebar">
          <div class="search-well-filter">
            <h5 style="color:blue;">South America Constitution Search</h5><hr>
            <span style="color:blue;">Filter Options</span>
            <p class="small" style="color:blue;"><b><span style="color:red;">{{number_format($south_america_countries_constitutions_count)}}</span>&nbsp;Results Found&nbsp;for&nbsp;<span style="color:red;">"{{$query}}"</span></b></p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-9">
        ...
        <div class="search-well">
            <h4 style="color:blue;"><b>{!! $south_america_countries_constitution->title !!}</b></h4>
          ...
          <br>
        {!! $south_america_countries_constitution->content !!}
        </div>
        <br>
        @endforeach                                    
      </div>
