<div class="only_1st_rep">
    ...
    <h5 style="color:blue;"><b>{!! $first_republic_law->title !!}</b></h5>
...
<div class="only_2nd_rep">
    ...
    <div class="search-well">
    <h5 style="color:blue;"><b>{!! $second_republic_law->title !!}</b></h5>
...
<div class="only_3rd_rep">
    ...
    <div class="search-well">
    <h5 style="color:blue;"><b>{!! $third_republic_law->title !!}</b></h5>
...
<div class="only_nlcd">
    ...
    <div class="search-well">
    <h5 style="color:blue;"><b>{!! $nlc_decree_law->title !!}</b></h5>
...
<div class="only_nrcd">
    ...
    <div class="search-well">
    <h5 style="color:blue;"><b>{!! $nrc_decree_law->title !!}</b></h5>
...
<div class="only_smcd">
    ...
    <div class="search-well">
    <h5 style="color:blue;"><b>{!! $smc_decree_law->title !!}</b></h5>
...
<div class="only_afrcd">
    ...
    <div class="search-well">
    <h5 style="color:blue;"><b>{!! $afrc_decree_law->title !!}</b></h5>
...
<div class="only_pndc">
    ...
    <div class="search-well">
    <h5 style="color:blue;"><b>{!! $pndc_law->title !!}</b></h5>
