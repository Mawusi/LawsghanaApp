...
<head>
  <title>Ghana News &mdash; Legal </title>
  <meta charset="utf-8">
          ...
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none pl-0 d-lg-block">
                <li class="active">
                  <a href="index.html" class="nav-link text-left">Ghana News</a>
                </li>
                <li>
                  <a href="categories.html" class="nav-link text-left">Africa News</a>
                </li>
                <li>
                  <a href="categories.html" class="nav-link text-left">Europe News</a>
                </li>
                <li>
                  <a href="categories.html" class="nav-link text-left">America News</a>
                </li>
                <li>
                    <a href="categories.html" class="nav-link text-left">Asia News</a>
                </li>
