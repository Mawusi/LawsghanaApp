                        ...
                        <div class="col-md-3" style="padding-top: 2.5em;">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form action="{{ url('only_amendments_index_search') }}" method="GET">
                                        {{ csrf_field() }}
                                            <input style="padding: 15px;" class="form-control" name="search_text" type="text" placeholder="Amendments word-search" aria-label="Search">
                                    </form>
                                </div>
                            </div>
                        </div>
