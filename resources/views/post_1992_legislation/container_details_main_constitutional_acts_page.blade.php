              ...
              <ul class="dropdown-menu table-wrapper-scroll-view" style="width: 520px;">
                  @foreach($allConstitutionalArticles as $allConstitutionalArticle)
                    <li>
                      ...
                      data-scroll-offset="-60" class="constitutional_view_all_section_link_with_prev_next" sid={{$allConstitutionalArticle->id}} href="/post_1992_legislation/constitutional-acts/content/{{ $allConstitutionalArticle->id }}">{{$allConstitutionalArticle->section }}
                      </a>
                    </li>
                  @endforeach
              </ul>
