...
<div class="panel-group table" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <?php }
                        ...
                        data-scroll-offset="-60" class="amended_regulation_content_link list-group-item" style="line-height: 0.1cm;" sid="{{ $allAmendedRegulationArticle->id }}"  href="/post_1992_legislation/amended_regulation_acts/content/{{ $allAmendedRegulationArticle->id }}">
