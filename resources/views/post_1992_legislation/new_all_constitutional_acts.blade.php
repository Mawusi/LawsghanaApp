...
<html lang="en">
  <head>
    ...
    <title>Constitutional Instruments</title>
                        ...
                        <div class="col-md-9">
                            <div class="list-group">
                                <table class="table table-striped table-condensed" id="datatable">
                                    <thead>
                                        <tr>
                                            <th>All Constitutional Instruments</th>
                                            <th>Year</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                        ...
                        <div class="col-md-3" style="padding-top: 2.5em;">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form action="{{ url('constitutional_instruments_index_search') }}" method="GET">
                                        {{ csrf_field() }}
                                            <input style="padding: 15px;" class="form-control" name="search_text" type="text" placeholder="Constitutional Instruments" aria-label="Search">
                                    </form>
                                </div>
                            </div>
                        </div>
