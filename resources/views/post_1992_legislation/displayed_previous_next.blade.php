...
<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="false">
    ...
    <?php }
                        ...
                        data-scroll-offset="-60" class="plain_previous_content_act list-group-item" style="line-height: 0.1cm;" sid="{{ $allPost1992Article->id }}"  href="/post_1992_legislation/plain-content/{{ $allPost1992Article->id }}">
