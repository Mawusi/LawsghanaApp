...
@section('content')
            ...
            <div class="container">
                <center><h3><b>{{ $allExecutiveAct['title'] }}</b></h3></center>
            </div>
            
            <br>
            
            <div class="container">	
                <h4 style="color:blue;">Preamble</h4><p>{!! $allExecutiveAct['preamble'] !!}</p>
                <hr>
                @foreach($allExecutiveArticles as $allExecutiveArticle)
                    
                        {{-- <h4>{{$allPost1992Article->part }}</h4> --}}
                        <h4 style="color: blue;">{{$allExecutiveArticle->section }}</h4>
