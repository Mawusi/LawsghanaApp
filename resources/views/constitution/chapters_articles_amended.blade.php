...
<div class="panel-group table" id="accordion" role="tablist" aria-multiselectable="true">
    ...
    <?php }
                        ...
                        data-scroll-offset="-60" class="constitution_amended_content_link list-group-item" style="white-space:normal; line-height: 0.4cm;" sid="{{ $constitutionContentAmended->id }}"  href="/constitution_amended/Republic/constitution_content/{{ $constitutionContentAmended->id }}">
