            ...
            <div class="d-flex p-m my-m">
                <div class="lh-100">
                    <form action="{{ url('all_constitution_index_search') }}" method="GET" class="form-inline my-2 my-lg-0 justify-content-center">
                        {{ csrf_field() }}
                        <input style="width:300px;" class="form-control mr-sm-2" type="search" placeholder="Search any word in Constitution..." aria-label="Search" name="search_text">
                    </form>
                </div>
            </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form action="{{ url('africa_constitution_index_search') }}" method="GET">
                                        {{ csrf_field() }}
                                            <input style="padding: 15px;" class="form-control" name="search_text" type="text" placeholder="Search word in Constitution" aria-label="Search">
                                    </form>
                                </div>
                            </div>
                        </div>
