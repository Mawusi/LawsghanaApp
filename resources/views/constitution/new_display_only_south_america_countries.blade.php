...
<html lang="en">
  <head>
    ...
    <title>South America Constitution</title>
                                ...
                                <table class="table table-striped table-condensed" id="datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="/constitution/1/{{ $south_americaConstitution->continent }}/{{ $south_americaConstitution->country }}/{{ $south_americaConstitution->id}}"><li style="list-style: none;">{{ $south_americaConstitution->title }}</li></a>
                                            </td> 
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form action="{{ url('africa_constitution_index_search') }}" method="GET">
                                        {{ csrf_field() }}
                                            <input style="padding: 15px;" class="form-control" name="search_text" type="text" placeholder="Search word" aria-label="Search">
                                    </form>
                                </div>
                            </div>
                        </div>
