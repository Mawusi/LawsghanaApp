...
<div class="col-md-2"> 
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <a class="expanded_link" id="expanded_link_toggle_all_pre1992_preview_1" href="/constitution_amended/Republic/expanded_view/{{ $ghana_act_amended['id'] }}"><li>Expanded View</li></a>
        <a href=""><li>Plain View</li></li></a>
        <br>
