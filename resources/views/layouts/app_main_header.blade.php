  ...
  <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="#">1st Republic</a>
          <a class="dropdown-item" href="#">2nd Republic</a>
          <a class="dropdown-item" href="#">3rd Republic</a>
          <a class="dropdown-item" href="#">NLC Decree</a>
          <a class="dropdown-item" href="#">NRC Decree</a>
          <a class="dropdown-item" href="#">SMC Decree</a>
          <a class="dropdown-item" href="#">AFRC Decree</a>
          <a class="dropdown-item" href="#">PNDC Law</a>
        </div>
      </li>
      &nbsp;&nbsp;
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          <a class="dropdown-item" href="#">Acts of Parliament</a>
          <a class="dropdown-item" href="#">Legislative Instruments</a>
          <a class="dropdown-item" href="#">Constitutional Instruments</a>
          <a class="dropdown-item" href="#">Executive Instruments</a>
          <a class="dropdown-item" href="#">Amendments</a>
        </div>
      </li>
      &nbsp;&nbsp;
      <li class="nav-item">
        <a class="nav-link text-dark" href="#">Case Laws</a>
      </li>
      &nbsp;&nbsp;
      <li class="nav-item">
                ...
                <div class="pt_for_content_container">
                    <div class="nav-scroller bg-header-color rounded shadow-sm">
                        <nav class="nav nav-underline">
                            <a class="nav-link active text-white" href="#">Case Laws</a>
                            <a class="nav-link text-white" href="#">Supreme Court</a>
                            <a class="nav-link text-white" href="#">Court of Appeal</a>
                            <a class="nav-link text-white" href="#">High Court</a>
                        </nav>
                    </div>
                </div>
